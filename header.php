            ...
            <div class="collapse navbar-collapse justify-content-end">
                <ul id="tabs" class="navbar-nav">
                    <li class="dropdown nav-item">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="notifications_area">
                            <span id="unseen_notifications_area"></span>
                            <i class="fa fa-bell"></i>
                            <span class="caret"></span>
                        </a>
                        <div class="dropdown-menu bg-dark" id="notifications_list" aria-labelledby="dropdownMenuLink" style="position: absolute;width: 200px;">
                        </div>
                    </li>
                    <li class="dropdown nav-item">
