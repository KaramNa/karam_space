...
if ($sql->num_rows > 0) {
    ...
    $con->query("INSERT INTO users(firstname,lastname,email,password,gender,birthday ,profile_picture) VALUES('$first_name','$last_name','$email','$newpassword','$gender','$birthday','$profile_picture')");
